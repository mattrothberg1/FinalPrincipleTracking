package com.example.quickstart.estimote;
...
public class NearestBeaconManager {
    ...
    static double pushingDistance = -1; //i put this in
    static Beacon beaconDetails;
    private static Beacon findNearestBeacon(List<Beacon> beacons) {
        ...
        pushingDistance = nearestBeaconsDistance; //I put this in
        beaconDetails = nearestBeacon;
        return nearestBeacon;
    }

    public static  double getDistance(){
        return pushingDistance;
    }

    public static Beacon getDetails(){
