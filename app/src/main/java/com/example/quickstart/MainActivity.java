...
import com.example.quickstart.estimote.NearestBeaconManager;
...
//start of estimote imports
import com.example.quickstart.estimote.BeaconID;
import com.example.quickstart.estimote.EstimoteCloudBeaconDetails;
import com.example.quickstart.estimote.EstimoteCloudBeaconDetailsFactory;
...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallApiButton.setText("Turn On");
        ...
        mCallApiButton2.setText("Turn Off");
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private void pushDataToSheet() throws IOException {
            ...
            row1.add(beaconName);
            Beacon beaconDetails = NearestBeaconManager.getDetails();
            row1.add(beaconDetails.toString());
            double currentDistance = NearestBeaconManager.getDistance();
            row1.add(currentDistance);
            DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
            Date date = new Date();
            row1.add(date.toString());
           // row1.add("HELLO");
            //add a column for signal strength
